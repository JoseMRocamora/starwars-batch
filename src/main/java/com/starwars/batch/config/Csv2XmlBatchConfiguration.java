...
/*    @Bean
    ...
    @Bean
    public ItemWriter<People> peopleWriter(PeopleRepository peopleRepository) {
    ...
    @Bean
    public Step csvStep(StepBuilderFactory stepBuilderFactory, ItemReader peopleReader, ItemProcessor peopleProcessor, ItemWriter peopleWriter, PeopleListener peopleListener) {
